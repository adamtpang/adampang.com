  ...
  return (
    <section className="relative mx-auto w-full max-w-3xl px-6 pt-32 pb-20 md:pt-40">
      ...
      >
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs uppercase tracking-label text-muted transition-colors hover:text-sunrise"
        >
          <span>←</span>
          <span>back home</span>
        </Link>
      ...
      <motion.div
        ...
        className="mb-6 inline-flex items-center gap-2 text-xs uppercase tracking-label text-muted"
      >
