    ...
    >
      <div className="relative overflow-hidden">
        ...
        <div className="flex flex-col ml-5 justify-center 2xl:mt-10 sm:-mt-6 sm:ml-8 md:ml-6">
          <div className="lg:text-lg xl:text-xl 2xl:mr-20 font-nunito dark:text-gray-300 space-y-2">
            <div><strong>Who:</strong> _____________</div>
            <div><strong>What:</strong> _____________</div>
            <div><strong>When:</strong> _____________</div>
            <div><strong>Where:</strong> _____________</div>
            <div><strong>Why:</strong> _____________</div>
            <div><strong>How:</strong> _____________</div>
          </div>
        </div>
      </div>
    </motion.div>
