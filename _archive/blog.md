...
would YOU read this essay? watch this video? listen to this podcast?
...
import docs
loud music thus cathartic, music is like a pattern of being. repitition with variation\n\npublic drafts, no more embarassing stuff, polish 1 thing, keep a ratio of polished and unpolished, thats a good idea\n\ngreat copy, great titles.\n\npublic drafts, no more embarassing stuff, polish 1 thing, keep a ratio of polished and unpolished, thats a good idea\n\nadd a comment section\n\nlinkedin update: under construction\n\ncomparrow all the blog post titles, then\n\ntwitter is like a newsletter. i want some to be highlighted and broadcast, other things to be optional to read\n\nbreadth then depth then breadth then depth ad infinitum\n\nthis blog is just public notes, sometimes curated\n\ni should label is this raw vs cleaned up. color code. hide what i doubt?\n\nim just gonna write what i want, ill make it for me like rick rubin said, and also thats how ill be a magnet for people like me, and vice versa, i gravitate to people i admire. its funny how magnets both attract and repel. polarization is the opposite of the lukewarm, be bolder. why?\n\ngenerate: speed and volume curate: if there is doubt there is no doubt excavate: push it to others\n\nimport all "@"keeps. gotta distill too\n\nput a pic to every blog post, like david perell\n\nsecret truths and fictions\n\ni love seeing when my heroes interact. here are some links. list subheroes too like huberman, casey\n\nafter cleaning, point to best blog posts on twitter\n\ntalk about the best of the twitter experiment, twitter curate. curation is thoughtful and useful\n\n3 writing sessions done\n\nadd pics. where to host? just link to it in markdown\n\nwriting online brings people into my headspace and maybe theyll hire me lol\n\npublic categorized notes to self and others. like a half blood prince notebook for others a cheatsheet\n\nput photos of me on personal site, gallery.\n\nconsolidate, like bring links out to the main page, less clicks, but more overwhelm...\n\nput nav buttons on sides of posts\n\nrate my own essays / blog posts, color code, point to the best ones on IG and twitter\n\nThe story till the state is good\n\nif i dont feel like im saying what i wanna say. ill fuckin stop. but right now ill go for speed and volume\n\nemail is king, start newsletter\n\ni can always do part 2s\n\nthe blogging and podcast ideas energizes me. i gotta code though too for the network state. lets walk through townhall. what would i use it for? just talking about guam? go for volume and speed and relevance, edit later\n\nthese tiny twitter and blog experiments build my confidence for bigger experiments like podcasting\n\ndo a talk with people i wanna talk to. parse ig twitter linkedin\n\nif there is even 1 counterexqmple, that wasnt a sufficient variable\n\noscillate between code and media. blog post a day, github commit a day on the relevant topic on the relevant project. the reason why this first before hardware is because its permissionless leverage. i mean i can learn hardware but i feel like id have to go to advanced manufacturing first since the scaling part is uber suck, like elon said. energy, gas, manufacturing houses like cover. but how do they differentiate.\n\ntalk about the 100 tweets experiment\n\nput google analytics on my site\n\nkeep talking about things relevant to me, till ive said what i wanted to say\n\nwhy not twitter? i dont want to force feed info to people\n\nmake arrow buttons on left and right of bottom of each  to navigate between posts\n\nfix [WARNING] Could not parse YAML metadata at line 6 column 1: :2:18: Unexpected '\n\nconsolidate files / posts\n\nindiehcakers i like\n\nadd an easy dm option at the bottom of each essay, so people can contact me from there. figure how thatll work. gpt it. add it to batch script. or actually just use an embed somehow. an email embed??? from who, what the message is.\n\nmy mongo to gundo plan\n\nreorder music post\n\nremove topics that aren't evergreen material\n\nplan learn build show tell\n\ndelete by topic first, add new ones. color code based on how ready they are. add relevant emojis to each title, shorten titles\n\nadd google analytics\n\n"chat with me" calendly\n\nso the daily game is. 1 blog post, 1 commit\n\ndelete the weird blogs\n\nput my DMs at the end of every blog post. how? email, phone number? dm me wherver\n\n"why im blogging and not tweeting" idk if im wrong, maybe i can balance these\n\nmy posts will get more nuanced over time, itll get cleaned up, noise will turn to signal. i should trim the titles too. i should put emojis in title.\n\ntalk about in format how im making the urls short. sivers inspiration\n\nwelcome to adams shitty blog\n\nsay that i respond to anyone reasonable, id love to hear what you think about anything ive said, dont be shy!\n\nwhy am i writing a shitty blog. make that the title\n\nwhat comes easy to me is talking a lot and asking a lot of questions. too much for some. i need to talk online and meet people online to satisfy this need for expression\n\ncheck previous personal site and what i wrote then\n\ndistill essays after a while, then riff more from my own essays, on spotify and youtube? ai trained? it needs data\n\njust focus on volume rn, dont edit, just post\n\nmaybe when a blog post gets too long, i can break it up into subparts and link to each\n\ncolor note by green yellow red, which essays are more polished than others. talk about that in the format. balance quantity and quality. but quality THROUGH quantity\n\nmake each title of post a directive\n\nwhy am i writing? whats the point of this? what if i say embarassing things? who am i writing to? does that matter? (rick rubin)\n\nadd a pic for each blog post, should appear in blog list\n\nmaybe writing online in markdown aint a good idea idk:\n\nTips for Using Markdown Headings: Use # for main titles and ## or ### for subheadings. Lists: Use - or * for bullet points and 1. for numbered lists. Emphasis: Use *italic* or **bold** for emphasis. Links: Create hyperlinks with [link text](URL). Images: Add images with ![alt text](image URL).\n\ni can always transfer content to wherever else\n\nin blog: i just wanna share stuff with people, and if i dont have people that wanna hear what i wanna say, i feel ignored\n\ntalk about projects i wanna do and why\n\nexperiment with pics and links. where do i host pics? store em?\n\nput a left and right button to cycle between different blog posts\n\nsign up to my newsletter\n\nright now just post a ton. do 100 thing MO\n\nexperiment with titles. click-bait? nah, accurate but to the point\n\ntalk about my life and why i made certain decisions\n\ni feel like so much content is repeated shit, noise. i dont wanna be like that\n\nwhat is code? services and indiehacking. what is media? blog posts, spotify audio essay, video podcast on spotify and youtube. whats the name? milk before cereal? adam pang pang.\n\nam i interviewing or just having a public conversation\n\nlist future project ideas and show whats pending vs finished. redo comparrow and sell on store\n\nshould you be able to sign up for a custom newsletter by topic? you can choose which tags? idk\n\nlets write first but what is are the criteria for how ill edit each node, or delete nodes, and ill just add nodes, do i categorize them? tag em?\n\nstart podcast. how can it be easy remotely?\n\ni wanna be an open book, idk it just feels right, so ill share stuff even if its embarassing or\n\ndo a newsletter for new blog posts\n\nblog about how the dont die and network state conferences went. link to things like ABOUT if they dont know about me, heres the breakdown of expenses and what i learned from each, why i went, my heroes, why i like them etc. they can change around. caveats for jordan peterson elon peter thiel. i like them, their controversial to some, i like the boldness, im not easily bothered, i like them for other reasons, i see why they bother people but i still admire certain dimensions of them.\n\ncheck if pandoc can do links and pics\n\ntrim the why blog\n\nshow my routine\n\nif i add pics to markdown, will that work? scapple pics, pics i want what else?\n\nrevise the why blog post\n\ntalk about how i wanna do a minimal podcast too\n\nwhat do i even start talking about? i guess whatever comes to mind, i can always curate later\n\ni originally wanted pics, and mindmaps too, and i can add those, but ill just start with text for now i wonder if markdown can do links too, ill see what happens\n\nafter i add blog, add store and list upcoming projects and in what order\n\ninclude GPT's thoughts with my blog posts\n\ni dont want to tweet as much as i do blog, because tweeting is like shoving words down someones throat, its forced into their feed, let it be optional. minimal advertisement that points to your longer body of work\n\nim doing a nights and weekends thing, no?\n\nstart a casual podcast, point to my blog, these are the topics im gonna talk about in the future, just be authentic\n\nget to double digits posting, and more apps of course. problems solutions people sales. keep going the more you are sure of it\n\ndo nature philosophy reels. bangers from X prompts. interesting topics like how balaji riffs\n\nmake online content, discussions, lectures, documenting what comes out of the weekly meetup.\n\nlet it cool for a couple weeks after doing the radical reset on ig and x, im building back up\n\ncreate curate elevate, in parallel. create everyday, curate everyday, elevate the best, everyday\n\nmake a personal discord, and put on my website, so people can join, and we can have async and sync comms\n\ncreate curate elevate. multiplying what remains, dividing what is left out.\n\nbuild something awesome, and the network will emerge. 1000 clips. 1000 commits.\n\nif not them, then find other people. be internet first, thats the real mental map\n\ncalendar of events.\n\ncreate curate elevate.\n\nevery post earns a follow\n\nquinn and vance reach out\n\nidea. code. media. wealth.\n\nproblem. solution. niche/people.\n\ninternet native, internet first.\n\nwhat do i want out of the medium?\n\n100 short clips of my best posts,\n\ncreate and curate. everyday create\n\nbe internet first: code and media.\n\ntitle: "✏️Why I'm writing a blog."\n\ndo a newsletter for new blog posts\n\nturn conversations into blog posts.\n\npracticing poetry on x, wordsmithing\n\ntalk with charlie about bella express\n\nX is for making your mind open source\n\nTalk about my future plans. Tech tree\n\nmake personal site pages like sivers:\n\nserendipity: location, code and media\n\n28 WIP apps 95 WIP essays 6 WIP songs\n\na labor of love\n\nlaborer of love\n\nread dannys blog\n\ngotta love nuance\n\nstories are memes\n\nemail sivers again\n\ncalendar of events.\n\nrefollow uncle roke\n\nfollow derek sivers\n\nWhy network states?\n\n“hey im from earth”\n\ndawg has awoken lol\n\nfollow noah mendiola\n\nmake a buymeacoffee?\n\nidea build show tell\n\nso many diff vibes..\n\nso many diff vibes..\n\nwhy do you care? idk\n\n"the internet dream"\n\ncreate curate elevate\n\nhang out with treyten\n\nidea feed action feed\n\ncreate curate elevate.\n\nlisten to readwriteown\n\nyouve been here before\n\nits nice to be back :)\n\nyouve been here before.\n\n"just press the button"\n\n“the trip and the trip”\n\n“the trip and the trip”\n\nim at around 750 commits\n\nfollow auntie rese again\n\nkeywords are thread fuel\n\nimport all writing notes\n\ndo an nsradio feature...\n\nevery post earns a follow\n\nfocus mostly on creating.\n\ndo another instagram poll\n\nshort am or anchor domain\n\ngrateful for the internet\n\nfollow ton manibusan again\n\nreach out and riff with oo\n\n13 mins from door to door.\n\nhang out with joseph green?\n\nsend manessa my soundcloud?\n\nlunch and gigis thing. tabs\n\n“the adventure of guessing”\n\ncreate an ig account for hww\n\nkeep creating, keep curating\n\nskillstack = category of one\n\ncheck if tristan hunt follows\n\nundo unused domains and repos\n\nDo proper capitalization now.\n\nfinish one pace on telegram..\n\n“and he saw that it was good”\n\nnaval is my intellectual spine\n\nthe girls already like me lol.\n\nPut this on adampang. Embedded\n\nantarctica is a cool band name\n\nthinking in public.. fallible.\n\nns is growing in discord number\n\nbrett hall tboi summary again..\n\ni want a wikipedia page one day\n\ninternet native, internet first.\n\npost all the IG clips to youtube\n\n"the busiest unemployed founder"\n\ndocs.new living doc embeded blog\n\ncoworking officel morning pages3\n\nwhat do i want out of the medium?\n\n100 short clips of my best posts,\n\nalso market fd chat and other gcs\n\nideasbugs will be an email button\n\nput all my IG X clips on youtube.\n\n“donavan is talking to users lol”\n\na clear calendar is a weird thing\n\ngigi ns commitment diary thingy 1\n\ncreate and curate. everyday create\n\nbe internet first: code and media.\n\nput ideasbugs on all landing pages\n\ntitle: "✏️Why I'm writing a blog."\n\nrepo made, code done, first dollar\n\ndo a newsletter for new blog posts\n\ncross post philosophy from X to IG\n\nput calendly and email on adampang\n\nread tboi, but first network state\n\nhave an offer, then create content?\n\nbusiness building is world building\n\nturn conversations into blog posts.\n\nquestion headline for each startup:\n\nmake a scorecard.social IG account.\n\nsumply amazing and amazingly simple\n\nreach out? https://x.com/shunyaekam\n\n"obvious to you, amazing to others"\n\ndo a vibecheck.me on all ns people.\n\nwe should have concerts at 1215 too\n\npinterest and spotify are my tiktok\n\neverything is a work in progress :)\n\nmake the scorecard social ig account\n\nmarket townhall to the coding meetup\n\npracticing poetry on x, wordsmithing\n\nns is a society with edit privelages\n\nget more headbands? nah laundry, idk\n\ntalk with charlie about bella express\n\nX is for making your mind open source\n\nTalk about my future plans. Tech tree\n\nfinish bannerbloom with all 3 Whoop s\n\nmake personal site pages like sivers:\n\n28 WIP apps 95 WIP essays 6 WIP songs\n\npost more. every post earns a follow.\n\nexperiment in breadth, see what works\n\nmorning coffee raves lol on the beach\n\nlook into cdixon 1000 true fans thing\n\nget to v1 on the projects on my plate\n\nnice to be back after some time away.\n\nmichael and i are running improv club\n\nask the guam content creators for help\n\nmake a beehiv newsletter? x is enough.\n\nsee indiehackingi write words and code\n\nimport all "@"keeps. gotta distill too\n\nhere's how i plan to format this blog:\n\nmake it not editable, but commentable.\n\nget a shorter anchor or am domain name\n\nblog post why i chose a half pseudonym\n\ncollab. find and build up awesome guys\n\nfind good names for studio agency club\n\nmake adampang and am site more visual?\n\nalso reach out to the stroll guam team\n\n8020 should auto-extract all the links\n\n1000 true fans > 1000000000 false fans\n\ni wanna sell what im proud of building\n\n“documenting existence while i exist.”\n\n“documenting existence while i exist.”\n\na new company or a department / feature\n\nethical wealth creation: code and media\n\nstartup ideas are in your daily routine\n\ncreate a start here on my personal site\n\nwhat do i want more of for the podcast?\n\nturn convos into blog posts and tweets?\n\nevery tweet can be expanded into a blog\n\nexperiment in breadth until you find it\n\nriff on the 200 old posts that survived\n\nput email on my site? a button adampang\n\nfollow all thiel fellows, find the list\n\nget more posts than what who you follow\n\nget to 10k posts then delete till 2000.\n\npost about reading FAN story and @ visa\n\ni just gotta last here. rest ethic shit\n\nprompting life in plaintext and voice..\n\nwe should go camping w boys here at ns.\n\nalso post youtube shorts. be omnipresent\n\nwe can weild the internet so much better\n\n489 days left. i love you god. thank you\n\nbuild what you cant buy or find for free\n\nsuperpower and farbood platform check it\n\nreminds me of game dev or song producing\n\nthis is not really saying anything huh..\n\nmake a cal like https://zackoverflow.dev/\n\ncurate down to 200 posts, then go to 10k.\n\npublish my master plan like camelliayang?\n\nmake a reverse chronological X posts sort\n\nwork on storytelling, humor, riffing. etc\n\ndo topic folders, then tiny essays inside\n\nevery blog post is a living doc. tag meta\n\ncreate curate (at mag thresholds) elevate\n\nwhat if i pooped. popped. brush. melaton.\n\nreach back out to weyboth about 8020best?\n\nfeels just like an extended conference rn\n\ninclude GPT's thoughts with my blog posts\n\nYo this is my google docs living doc blog\n\nthe united network states of the internet\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nCreated by Adam Pangelinan via caldump.com\n\nthen when i find the good ones put on site\n\nhave a categories filter for my blog posts\n\nmake 8020best have a flat 10 dollar price?\n\npost the best performing replies and posts\n\nCreated by Adam Pangelinan via caldump.com\n\n“these llms arent gonna prompt themselves”\n\nmake a user traits page: takes x to respond\n\nsell to people on internet who could use it\n\nmake sure theres a way to create and curate\n\nadd vibecheck and my soundcloud to adampang\n\nadd a vocab list with every mindspacer/hero\n\njust be yourself, at scale, on the internet\n\ni just wanna be the rick rubin of tech haha\n\nupdate AM remove links, add scorecard.social\n\ntopicize my essays. tag each in the markdown\n\nblog about each startup written by adampalm?\n\nriff on the best 250 posts that i curated to\n\ninternet first. learn skills, build projects\n\nmake posts spiky, make replies complementary\n\ninternal ns houses. 10 points to gryffindor.\n\ngo and own my domain names, not just rent it\n\nhelp alex making a quick website and domain?\n\nnsbnb on Apr 24, 2025 at 11:00 AM - 11:30 AM\n\n100 solo duo clips. x ig tiktok youtube. pods\n\ni only need 1k mrr to be profitable basically\n\nthe best 20 tweets from my 100 day experiment\n\nmake rating gantry. tentative live tier lists\n\ndo super concise salient highlights and tldrs\n\n1000 true fans. people you WANT to follow you\n\ninternet first, not local first. url then irl\n\nLiving doc #1 (a work in progress tiny essay)\n\ni want that, cant buy it, so ill build it lol\n\nput site analytics on all my sites. free shit\n\nmake the means of creation frictionless, easy\n\nfind am x and ig, or just post from my acount\n\nput scorecard social into xray social instead\n\nfollow brandon marsh on ig and x? if hes open\n\ncheck w vivaan for col bedroom bunking at ns?\n\nwork on ns radio eventually to stay committed\n\nlook this up: how to start a notion blog easy\n\ni like being "indie" in all creative aspects.\n\nevery blog post has a thumbail and tweet-title\n\nwrite, twitter, youtube, substack (newsletter)\n\nblog on substack and have that newsletter? idk\n\nput this on adampang: https://volt.fm/adampang\n\ndo karaoke w dawn and she sings ms jackson lol\n\ni was planning cities w pigville when i was 10\n\nmake adampang the main and point the rest to it\n\nif i can build these projects out. step by step\n\nevery startup needs a "feedback? little button"\n\nput a pic to every blog post, like david perell\n\nmake sift best public, auto formatting and shit\n\nOnce you’ve tasted ambrosia, you can’t go back.\n\nWhat if I do project diaries? Light90.com 1 etc\n\nfind a short anchor domain. find it on namecheap\n\nhybrid online offline. old and new. yin and yang\n\ncharge phone on Feb 7, 2025 at 7:30 PM - 8:00 PM\n\nhave a different name for the studio agency club\n\non ig, share the visual, on x, share the mental?\n\nig carousel on Apr 16, 2025 at 7:30 AM - 8:00 AM\n\ncheck email on Apr 20, 2025 at 9:00 AM - 9:30 AM\n\nathon’s “memes and incentives” thats really good\n\nhow will i plan, learn, build, show, tell, today?\n\nshow what services you offer, show top3 portfolio\n\nminimal clicks to problem solved, on all startups\n\nworking on my indiehacking company anchormarianas\n\nmake 100 1 minute solo clips too. but about what?\n\nwe are selling the results of our trial and error\n\npost more philosophy reels, and do pods too at ns\n\nturn my content consumption into content creation\n\nfind the defender memetic guy on x and tell athen\n\njournaled for twelve pages straight at the cafe..\n\n100,000 code sales. 100,000 media leverage videos?\n\nat 1k posts curate based on founder and market fit\n\nthe best private notes make it to public notes (X)\n\nbe scrappy, bootstrap, get clarity through writing\n\nmake a really good headline for each tool/platform\n\ntboi provides pillars that i orbit and grow around\n\ntalk about freelancing and stripe atlas experience\n\nbest of private notes makes it to public notes / X\n\nnurture my first few followers. be easy to follow.\n\nget paid 250 for hilton, then mama stripe invoice.\n\nget the grab to sg fc thing fast so we unlock yhat\n\nleave an internet rabbit hole for the other "you"s\n\nhww free at first with testimonials, then charge...\n\nfind or make a free reports+ followers for ig and x\n\ntalk about my life and why i made certain decisions\n\nput loom demo videos in every startup landing page?\n\n500 v follows and 5 million engagements is the new…\n\npost more engaging posts like polls, questions, etc\n\nwhy am i writing a shitty blog. make that the title\n\nok tierrank by which ones id use now. idea presale.\n\nimprove am site. get an am domain or anchor domain.\n\nhave calls with jared and other cool nautilus peeps\n\nmake an email host via adampang andor adamtpang.com\n\nmake adampang the main and all relevant point to it\n\nbuild something amazing and the network will emerge\n\nmake a youtube commentts for vids with no comments?\n\ndo karaoke again? better dj app.. ns projects list?\n\ndescribing myself blog post: sovereign individual ++\n\nafter 1k posts. get down to 200 posts. 8020 curation\n\ngoing for first internet dollar lol. never giving up\n\nmake an anchormarianas twitter page and link from my\n\nriff with people and see if they riff back, thats it\n\nget to 100 IG posts, THEN curate. create then curate\n\nfollow tanner on socials, hes an awesome guy i think\n\n"make nuance cool again" "make america states again"\n\n"improve am site. get an am domain or anchor domain."\n\nget adampalm.com @adampalm ig twitter etc youtube etc\n\npermissionless first. internet first. VALUE YOUR TIME\n\nshow places/things im interested in and show my plan?\n\nput a "how it works" on every startup landing / about\n\nmake a /tip /pod /call links on site. tier list links\n\nupdate caldump with problem solution how landing page\n\nlook at raymar football, jedcal, auntie yuri, pia mia\n\ncreate curate create curate. messy clean messy clean.\n\n“i dont want to join the group that will take me” lol\n\nfollow 1k on ig x warpcast? make a crypto ig? nah idk\n\nTheres like a double bad. Philosophy of social media.\n\nwhat makes nomads.com different crom ns.com/dashboard\n\nlending library, we do projects. brainstorm, bodystorm\n\nfind a time and place. a place to both discuss and act\n\nmake posts exportable/shareable to other media formats\n\n1 parse posts, thread all the remaining / wordsmith em\n\nrank my digital tools by importance, 0-5 for blog post\n\nget adampang.io and make blog.adampang.com or whatever\n\nportfolio of leverage and indiehacking. code and media\n\nturn public to private. turn url to irl. create curate\n\nput the hilton on my agency website. studio and agency\n\npost to X: https://www.youtube.com/watch?v=NZd3R2iw4cA\n\npair the visakanv bullshit post with my gratitude post\n\n30 minutes office hours with jasmin? recurring in cal?\n\nlook to blake anderson andrew kirby playbooks whatever\n\nthe cutish malay girl who works at ns cafe is "daewiy"\n\nyeah the pod counts as meeting people for the bootcamp\n\nturn room dnd on on Apr 19, 2025 at 9:30 AM - 10:00 AM\n\n"theyre not making new land" on the internet they do..\n\nspent a lot of the time basically reading and writing.\n\nDaily 50% product, daily 30% marketing, daily 20% sales\n\nToo short to suck: a no-fail secret to creating content\n\ninput the existing 8020best list into the new sift.best\n\ni need to make sales more. rebuild, relaunch 8020.best.\n\n4 auntie creed nucleus package and business usa address\n\nat 1k posts, curate. founder and market inform curation\n\n1 10 100 minutes vids. do 100 thing. 100 code 100 media\n\nmake sure all posts are threaded wordsmithed parsed or…\n\nhow do you know what to post or not? timeless or timely\n\njust make interviewing a natural part of my online life\n\n• building bodies of work (code and media) adampang.com\n\n• building bodies of work (code and media) adampang.com\n\nthe sovereign child rag with book distillation. tldr.ai\n\ngummy search for infleuncers: https://influencers.club/\n\nmake an indiehacker pseudonymous account? earning name?\n\ndiff x accounts for different vibes? timeless, temporary\n\n, then each of those topics can have essays within them.\n\nadd a pic for each blog post, should appear in blog list\n\nmy project name is semi-bound by domain availability lol\n\nCAN YOU GUESS WHO IM FUCKIN IMPERSONATING    CAUSE I CAN\n\nmake a post about my fav accounts to follow, on IG and X\n\ncontent for dicoverability vs virality. write about this\n\nvisakan = friendship creation and being an online citizen\n\nmake adam palm the presales cart site? or anchormarianas?\n\nblog post, pic, audioblog, and a visual video. ai help me\n\npost to X relevant communities https://x.com/compose/post\n\nuse substacks or beehiv for email newsletter blog thingy?\n\nwhen i reach 1000 posts, trim away the non-reposted posts\n\n** man i forgot something really cool i forgot. whatever.\n\nas long as its high quality high authenticity, release it.\n\n1,1,make personal site like this?: https://www.audrics.me/\n\nupgrade personal site. what makes a personal site amazing?\n\nmake a newsletter for each topic tag people want to keep up\n\nmake an email list lik https://www.divyavenn.com/subscribe?\n\nthis blog is basically like eventually curated public notes\n\nif there is a counterexample, it wasnt a sufficient variable\n\nmake it easy for me to modularize and do my personal website\n\na daily roundup mcp discord bot? luma calendar reminder? nah\n\nmix “what i do” content, with preselection and selfie content\n\nSome essays should be tagged and lead back to certain topics.\n\nwriting: make it easy for people to find you, AND find people\n\nalso invite otherrs to collab on ideas from my presales site.\n\nof my best replies that can stand alone. repost them as posts\n\nevery keep is a blog post perhaps, the ones that stick to top\n\nmake adampang the main repo and the other domains point to it\n\nsend donavan my raw question thing via discord. async for him\n\nevergreen content. things that last. art, business, that lasts\n\nyou can also combine old content together, recycle it reuse it\n\nremove bad projects from am site. and get a better domain later\n\nmake my own almanack like ben franklin. pithy shit. a blog post\n\nput faces on pod clips going forward. still use descript though\n\nfollow daniel osbourne and cyle tass again? well theyre private\n\njust do rag book distillations for balajis book club pre-dinner\n\nprint the ns book. find the physical book. have it open on tabs\n\nadd logos to the AM site, with screenshots on landing and looms.\n\nmake sift.best and caldump.com freemium? idk. one time purchase.\n\nimport the old blog workspace, old personal site with the blog..\n\ncreate and curate. high quantity high quality high authenticity.\n\ncalendly and tip page on adampang? check the old smile version..\n\nmake soccer clips, philosophy clips, kpop clips, tech clips, etc.\n\ncreate curate elevate, all at the same time. in parallel and shit\n\nput a left and right button to cycle between different blog posts\n\nput on AM site that ive got many many more ideas. infinite ideas.\n\nmake adampang site more white, but with cool aesthetics. later...\n\nmama youtube premium get it? on Apr 12, 2025 at 4:45 AM - 5:15 AM\n\nevery from:adamtpang keyword search is a thread waiting to be made\n\nas long as youre building code or media leverage, its not a waste.\n\nadd 1 song to media lwverage? all backlinking to my internet name?\n\nif there is even one counterexample it wasnt a sufficient variable\n\npost on X consistently. keep posting with 8020 and caldump helping\n\npost more. more apps. more clips. less followijg follower whatever\n\nshow previous projects that are relevant to the discussion channel\n\n100 days of ns diary material. begin with the photo/video. archive\n\nif there is even 1 counterexample, it was not a sufficient variable\n\nget to 10k posts, THEN curate. listen to what you write to yourself\n\nIMO, the best 20% of tweets from my 100 days of tweeting experiment\n\nput my website and now page and contact on email signature and logo.\n\nfix now page so i can link people to it what ive been up to recently\n\non my now page, put date location, tldr of what im up to, highlights\n\nadd feedback form. sync and async written and spoken word. my email,\n\nremove the excess links from anchormarianas, and the 100 apps thing?\n\nif there is even 1 counterexample then it wasnt a sufficient variable\n\nwrite aboout why i made a personal logo, and tie it into fame writing\n\ntalk about sabatier, link to casey and s3. figure out the jekyll thing\n\nmake it a clearer link to each other between 8020.best and caldump.com\n\nmake a site like chris dixon. upgrade adampang based on platonic ideal\n\nafter 100 tweets, curate: is this timeless? is this a complete thought?\n\nsell comparrow. give percentage of how much ive coded each presale idea\n\ni write to untangle my mind, and to note down tasks for later compiling\n\nbasically like notes to self and to the world, documenting mind and life\n\nfind the best replies and make them into quote posts / reposts / threads\n\nafter i add blog, add store and list upcoming projects and in what order\n\nif you create the outline of the puzzle, the missing piece becomes clear\n\nget an indiepa.ge? then it will market to other indiehackers via the bot\n\nlet the work speak for itself. people can make content about your shit..\n\n"people are the best search engines" hence podcasts.. but post and ghost\n\n"all it takes is one creation to point to the portfolio. all it takes i…"\n\nmake a newsletter eventually? itll just link to my new dailyish blog post\n\n"after polished caldump and 8020best, post to communities on X, just li…"\n\nfinish siftbest and redirect 8020 to it? just merge the codebases together\n\nevery creation earns an audience member. create your best curate your best\n\nif there is even one counterexample, then it was not a sufficient variable\n\nmake my essays like sivers. short and sweet, with a pic, with audio ramble\n\n2/100 pods done! 0/100 solo clips. 1000/1000 X posts done! 1/100 apps done\n\n1 title 1 slug 1 content 1 thumbnail? differing feed box sizing for variety\n\nwriting online brings people into my headspace and maybe theyll hire me lol\n\nonly tweet what i would say to myself, thats the blog filter. value vectors\n\nkeep talking about things relevant to me, till ive said what i wanted to say\n\ncreate socials for each for lemon squeezy review. needs logos then for each?\n\nfinish last 50 tweets. drafts, skim off the top to share. like new projects.\n\nmake my network effects projects open source, like townhall and skill supply\n\njust post in lowercase with no periods going forward for a bit, less is more\n\n"why im blogging and not tweeting" idk if im wrong, maybe i can balance these\n\nblog newsletter https://www.perplexity.ai/search/ghost-.lsZJZ3oSrqE6oVhbTKIww\n\npost on airchat and tiktok too. always leave a link to my central hub website\n\ngenerate, curate, excavate: create topic framework, write, delete, write more\n\ni feel like so much content is repeated shit, noise. i dont wanna be like that\n\nevery keep is a blog post with a pic. 2 paragraphs. pick a positive constraint\n\nwrite about ns in an essay and put referral code there. tell yash what i think\n\nns diary entry write/stitch + IG story? on Apr 24, 2025 at 11:15 AM - 11:45 AM\n\npaid boilerplate is like paid content, like a blog or a patreon. easily pirated\n\na ton of my keeps writing should be going to warpcast, x. a double poster tool?\n\nthen do meta threads that are similar, like digital tools and chrome extensions.\n\nwisdom is nuance (closer to throughline, invisible calculus, source, logos, dao)\n\ntie 8020.best and caldump to each other, and both to AM site, and AM site to me.\n\nfor every site: ideasbugs.insertsite.tld: https://ideasbugs.levels.io/hotel-list\n\ndo another podcast, check shortlist. build something and the network will emerge\n\nif not them, then find other people. be internet first, thats the real mental map\n\nmake a caldump.com loom / gif showing how it works. clean profile. guest profile?\n\npost sivers if its not a hit switch. aggregate each exemplars stuff into a thread\n\nmake arrow buttons on left and right of bottom of each  to navigate between posts\n\ntie my blog to a newsletter, find a cheap one or open source one idk. substack???\n\nshift to sift.best, and tell sage and the other customers about it. and X and IG.\n\nput my email online too, so people can derek sivers me. also a /call a /tip a /pod\n\nmake linkify cause it would really help speed up my blog process and now page etc.\n\nWork on drafting and saying how finished i feel it is in communicating the thought\n\nhave a now page, a hi page, a laugh page, a listen, see, contact. directives pages\n\nmany stories till a caraosel ig post, those will be pinned? the inflection points?\n\nImport the blog workspace thing.. Check the old blog.. The line by line insights..\n\nImport from blue keeps and also blog workspace.. Put it all through blog workspace\n\nshow philosophy tech soccer biohacking music content. be my authentic mosaic. 8020a\n\nits not spray and pray, its volume and speed, curating and trying to break my ideas\n\nmake adampang the main site, not adampangelinan. make pangelinan direct to adampang\n\nengage more also with high quality small mag following accounts. well grow together\n\nput back my cal.com link on adampang. skool.com is where i build my online business?\n\nlet people +2-2 upvote downvote every line on my blog, then i can tweet those lines.\n\neach blog post have a views post, tag categories, and an last updated x days ago. **\n\nig for my projects and camera roll and more posts for cool shit = visible competence\n\nmaybe when a blog post gets too long, i can break it up into subparts and link to each\n\ni want 1 creative outlet where i can say more timely things, and 1 for curated timeless things\n\nmaybe have some blog posts first on important things. well i can hower my ideas and check my blog workspace\n\non my twitter, say that every tweet has a blog version at adampang.com/blog maybe get adam.blog or something\n\nexpand on my best posts, the ones i repost the most. do like derek sivers blog, or chris dixon blog posts. v1 v2 etc\n\ntake my experiences and put on social media? stop at 6 figures? talk about the experiences of being here at ns, the people. content? how to make it easy?\n\nor like david perell's. make a blog like this: https://caseyhandmer.wordpress.com/ use pinterest or ai images to convey what i want.. like moodboards, then it can help you make images..\n\ni dont want to tweet as much as i do blog, because tweeting is like shoving words down someones throat, its forced into their feed, let it be optional. minimal advertisement that points to your longer body of work\n\nWrite about being down bad at ns for the first few months. Articulate why. For me, and then share? What things should i share online vs not? Discoverability, depth, virality, these are the apparent variables at play\n\ndo the bullet point autobio with little modals in the md when i want to go deeper on something, like philosophy and dead philosophopers society. make it so those words are highlighted and clickable for more context, over and over so the page is much more 3d\n\nmake a directives blog post just like sivers. i have posts about topics, and then i can write some more specialized for a specific concept, but still use links to visualize. i can also make some kind of pagerank 1 layer deep link visualizer to see where each topic goes url-wise, which posts have the most words, etc.\n\nevery keep is a blog post perhaps, the ones that stick to top\n\nif there is even 1 counterexample, it was not a sufficient variable\n\nmake a newsletter eventually? itll just link to my new dailyish blog post\n\nmake like 2 paragraph blog posts, short-medium thoughts with a picture with it. AI or chosen\n\ni want 1 creative outlet where i can say more timely things, and 1 for curated timeless things\n\nat the bottom of every blog post, make a "any thoughts? dm me here *insert text block* that is an email\n\nmake every blog post have a timestamp from the build.sh script so its in chronological order from the last time i touched it. and use an emoji??? no blog post titles, only topics. the slug and the topic is a living doc, not a static blog ill have...\n\n